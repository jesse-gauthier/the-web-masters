<template>
  <div class="privacy-policy p-8 max-w-3xl mx-auto">
    ...
    <p class="mb-4">
      This website (the "Site") is owned and operated by Ottawa Web Masters is the data controller
    ...
    <p class="mb-4">By using our Site, users agree that they consent to:</p>
    <ul class="list-disc list-inside mb-4">
      <li>The conditions set out in this Privacy Policy</li>
    </ul>
    <p class="mb-4">
      If you withdraw your consent, it will not make processing which we completed before you
      withdrew your consent unlawful.
    </p>
    <p class="mb-4">You can withdraw your consent by emailing Contact@ottawawebmasters.ca.</p>

    <h2 class="text-2xl font-semibold mb-4">Personal Data We Collect</h2>
    <p class="mb-4">
      We only collect data that helps us achieve the purpose set out in this Privacy Policy. We will
      not collect any additional data beyond the data listed below without notifying you first.
    </p>
    <h3 class="text-xl font-semibold mb-4">Data Collected Automatically</h3>
    <p class="mb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">How We Use Personal Data</h2>
    <p class="mb-4">
    ...
    <p class="mb-4">The data we collect automatically is used for the following purposes:</p>
    <ul class="list-disc list-inside mb-4">
      <li>Statistics</li>
    </ul>
    ...
    <h3 class="text-xl font-semibold mb-4">Other Disclosures</h3>
    <p class="mb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">How Long We Store Personal Data</h2>
    <p class="mb-4">
      User data will be stored until the purpose the data was collected for has been achieved. You
      will be notified if your data is kept for longer than this period.
    </p>

    <h2 class="text-2xl font-semibold mb-4">How We Protect Your Personal Data</h2>
    <p class="mb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Your Rights as a User</h2>
    <p class="mb-4">Under the GDPR, you have the following rights:</p>
    <ul class="list-disc list-inside mb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Children</h2>
    <p class="mb-4">
      ...
      with personal data, their parent or guardian may contact us.
    </p>
    ...
    <p class="mb-4">
      ...
      personal data, if we have disclosed your personal data and to whom we disclosed your personal
      data, if you would like your data to be deleted or modified in any way, or if you would like
      to exercise any of your other rights under the GDPR, please contact us at:
    </p>
    <p class="mb-4">Email: Contact@ottawawebmasters.ca</p>
    ...
    <p class="mb-4">
      ...
      collect data relating to the user's browsing habits. You can choose to be notified each time a
      cookie is transmitted. You can also choose to disable cookies entirely in your internet
    ...
    <ul class="list-disc list-inside mb-4">
      <li>
        <strong>Functional cookies</strong>: Used to remember the selections you make on our Site so
        that your selections are saved for your next visits
      </li>
      <li>
        <strong>Analytical cookies</strong>: Allow us to improve the design and functionality of our
      ...
      <li>
        <strong>Targeting cookies</strong>: Collect data on how you use the Site and your
        preferences. This allows us to personalize the information you see on our Site for you.
      </li>
    </ul>
    ...
    <p class="mb-4">
      ...
      that our users periodically review our Privacy Policy to ensure that they are notified of any
      updates. If necessary, we may notify users by email of changes to this Privacy Policy.
    </p>

    <h2 class="text-2xl font-semibold mb-4">Complaints</h2>
    <p class="mb-4">
      If you have any complaints about how we process your personal data, please contact us through
      the contact methods listed in the Contact Information section so that we can, where possible,
      resolve the issue. If you feel we have not addressed your concern in a satisfactory manner,
      you may contact a supervisory authority. You also have the right to directly make a complaint
      to a supervisory authority.
    </p>

    <h2 class="text-2xl font-semibold mb-4">Contact Information</h2>
    <p class="mb-4">If you have any questions, concerns, or complaints, you can contact us at:</p>
    <p>Email: Contact@ottawawebmasters.ca</p>
  </div>
</template>
