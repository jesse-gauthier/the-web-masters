<template>
  <div
    class="hero min-h-screen overflow-hidden bg-opacity-5 bg-fixed"
    role="img"
  ...
  >
    <div class="hero-content text-neutral-content inner-wrapper">
      <div class="md:grid grid-cols-1 md:grid-cols-6 gap-x-5">
        <div class="self-center md:col-span-4 lg:col-span-3 md:col-start-1 text-black">
          <h2 class="mb-5 text-4xl md:text-5xl font-bold tracking-widest text-white">
            Ottawa Web Design, SEO and E-Commerce Strategy
          </h2>
          <p class="mb-5 text-2xl font-medium text-left text-white">
            Our web design and SEO strategies are designed to significantly increase traffic and
        ...
        <img
          class="hidden w-[100%] mt-5 md:mt-0 rounded-xl self-center md:col-span-2 md:col-start-5 max-h-[70vh]"
